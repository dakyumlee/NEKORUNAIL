...
window.deleteGalleryItem = async function(docId, imageUrl) {
    ...
    try {
        const { doc, deleteDoc } = await import('https://www.gstatic.com/firebasejs/9.23.0/firebase-firestore.js');
        const { ref, deleteObject } = await import('https://www.gstatic.com/firebasejs/9.23.0/firebase-storage.js');
...
console.log('=== Firebase v9 관리자 스크립트 로드 완료 ===');